 ...
 * @author JustisR
 * 
 *         Any questions, comments, or suggestions, feel free to contact me via skype at "justis.root@gmail.com"
 * 
 *         Version 2.0
 * 
 */
...
public class JsonMessage {
	...
	public static class JsonStringBuilder {
		...
		/**
		 * @deprecated Achievements were replaced with Advancements as of v1_12, and are formatted individually through show_text. Set the hover event's action as showing an achievement
		 * @param ach the achievement to be displayed. for list of achievements, visit <a href="http://minecraft.gamepedia.com/Achievements">here</a>
		 * @return the json string builder to which you are applying settings
		 */
